    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', compositefk.fields.CompositeForeignKey(null_if_equal=[], on_delete=django.db.models.deletion.CASCADE, to='dataParser.Course', to_fields={'semester': compositefk.fields.LocalFieldValue('semester'), 'subjectCode': compositefk.fields.LocalFieldValue('subjectCode'), 'year': compositefk.fields.LocalFieldValue('year')})),
            ],
        ),
        migrations.CreateModel(
            name='Lecture_method',
        ...
        migrations.AddField(
            ...
            name='course',
            field=compositefk.fields.CompositeForeignKey(null_if_equal=[], on_delete=django.db.models.deletion.CASCADE, to='dataParser.Course', to_fields={'semester': compositefk.fields.LocalFieldValue('semester'), 'subjectCode': compositefk.fields.LocalFieldValue('subjectCode'), 'year': compositefk.fields.LocalFieldValue('year')}),
        ),
        migrations.AddField(
            model_name='book',
            name='course',
